...
Prepare a report showing whether the customers who purchased the named product have purchased the following three products.
...
--'Customers purchasing 'Polk Audio - 50 W Woofer - Black'
...
--customer_id, name, surname, 1st product info, 2nd product info, 3rd product info
